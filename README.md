...
```bash
# Step 1: Generate synthetic dataset (10K+ reviews)
python src/data_generator.py

# Step 2: Run the full NLP pipeline
...
| Sentiment Accuracy (vs. star-based) | ~87% |
| Topics Discovered | 12-18 clusters |
| Outlier Rate (Topic -1) | <15% |
| Pipeline Throughput | ~500 reviews/sec |
...
├── src/
│   ├── __init__.py
│   ├── data_generator.py     # Synthetic review generation
│   ├── preprocessor.py       # Text cleaning & normalization
│   ├── sentiment.py          # VADER sentiment analysis
│   ├── topic_model.py        # BERTopic + TF-IDF clustering
